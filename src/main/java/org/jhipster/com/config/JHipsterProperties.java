...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "midApp2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "midApp2 API";

        private String description = "midApp2 API documentation";
